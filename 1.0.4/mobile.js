...
(function(window, navigator){
	...
	Mobile.isMobile = function (){
		return /android|webos|ip(hone|ad|od)|opera (mini|mobi|tablet)|iemobile|windows.+(phone|touch)|mobile|fennec|kindle (Fire)|Silk|maemo|blackberry|playbook|bb10\; (touch|kbd)|Symbian(OS)|Ubuntu Touch/i.test(navigator.userAgent)
	}
	...
	//localStorage.setItem("a","值")
	//localStorage.getItem("a")
	//localStorage.removeItem("a")
	//localStorage.clear()
	//localStorage.key(i) ->第i个的对应键
